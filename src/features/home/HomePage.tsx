            ...
            <div className='videos'>
              <div className='video anim' style='--delay: .4s'>
                ...
                <div className='video-view'>
                  54K views<span className='seperate video-seperate'></span>
                  1 week ago
                </div>
              </div>
              <div className='video anim' style='--delay: .5s'>
                ...
                <div className='video-view'>
                  42K views<span className='seperate video-seperate'></span>
                  1 week ago
                </div>
              </div>
              <div className='video anim' style='--delay: .6s'>
                ...
                <div className='video-view'>
                  64K views<span className='seperate video-seperate'></span>
                  2 week ago
                </div>
              </div>
              <div className='video anim' style='--delay: .7s'>
                ...
                <div className='video-view'>
                  50K views<span className='seperate video-seperate'></span>
                  1 week ago
                </div>
              </div>
            </div>
                ...
                <div className='video-detail'>
                  <div className='video-content'>
                    ...
                    <div className='video-p-subtitle anim' style='--delay: .3s'>
                      ...
                      sit amet consectetur adipisicing elit. Debitis earum velit accusantium maiores qui sit quas, laborum voluptatibus 
